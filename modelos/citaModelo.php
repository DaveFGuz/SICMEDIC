<?php 
	...
	class CitaModelo extends mainModel{
		...
		protected function agregar_cita_modelo($datos){
            ...
            $sql=mainModel::conectar()->prepare("INSERT INTO `tcita` (`idcita`, `idpaciente`, `nombre_citado`, `fecha_hora_cita`, `estado_cita` ) 
            VALUES (NULL, NULL, :nombre_citado, :fechahoracita ,'1' );");
