            ...
            <div class="modal-dialog">
                <div class="modal-content">
                                    ...
                                    <div class="tabbable">
                                        ...
                                        <div class="tab-content">
                                            <div id="home" class="tab-pane fade in active">
                                                ...
                                                <br>
                                                        <select multiple="" id="state" name="state"  class="select2" style="width: 500px" data-placeholder="buscar paciente">
                                                        ...
                                                        <div class="form-group col-lg-12">
                                                            <label for="inputName" ><i class="fa fa-edit"></i> Asunto o Nombre</label>
                    ...
                    <div class="modal-footer no-margin-top " >
                        ...
                        <button class=" btn btn-danger btn-white btn-round pull-left" style="margin-top: 10px" data-dismiss="modal">
