...
<div class="modal-body no-padding" style="background: #fcf8e3">
     ...
     <form id="formpac" data-form="save" action="<?php echo SERVERURL?>/ajax/pacienteAjax.php"  method="POST" enctype='multipart/form-data'  >
...
<div class="tab-content" style="height: 400px;">
        ...
        <div class="form-group col-lg-6">
            <label for="pacnombre">Nombre(s) <a>*</a></label>
                <input type="text" class="form-control" name="pacnombre" id="pacnombre" placeholder="" />
        </div>

        <div class="form-group col-lg-6">
            <label for="pacapellido">Apellido(s) <a>*</a></label>
                <input type="text" class="form-control" id="pacapellido" placeholder="" />
        </div>
        ...
        <div class="form-group col-lg-6">
            <label for="pactelefonosec"><i class="ace-icon fa fa-phone"></i> Teléfono Secundario <a> </a></label>
                <input class="form-control input-mask-phone" type="text" id="pactelefonosec" name="pactelefonosec" />
        </div>
    ...
    <div class="tab-content" style="height: 250px">
        ...
        <div class="form-group col-lg-6">
            <label for="que"><i class="fa fa-male bigger-110"></i>  Es </label>
