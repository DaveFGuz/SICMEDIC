                                                                ...
                                                                <div class="clearfix" style="background: #2aa5a5;color: #FFFF;padding-top: 5px;padding-right: 5px">
                                                                    ...
                                                                    <div class="pull-right tableTools-container" >
                                                                        ...
                                                                        <div class="dt-buttons btn-overlap btn-group" >
                                                                            ...
                                                                            <a class="dt-button buttons-collection buttons-colvis btn btn-white btn-primary btn-bold" aria-controls="dynamic-table" data-original-title="" title="" data-toggle="modal" data-target="#modal-table">
                                                                                <span>
                                                                        ...
                                                                        <table id="dynamic-table" class="table table-striped table-bordered table-hover   dataTable no-footer" role="grid">
                                                                            ...
                                                                            <thead >
                                                                                <tr role="row" style="background: #ffff">
                                                                                    <th style="width: 10%"><strong>ORDEN</strong></th>
                                                                                    <th style="width: 50%"><strong>PACIENTE</strong></th>
                                                                            ...
                                                                            <tbody>
                                                                                    <tr role="row" class="odd active">
                                                                                            ...
                                                                                            <td>1</td>
                                                                                                ...
                                                                                                <td>  JAZMIN BEATRIZ FLORES GUZMÁN</td>
                                        
                                                                                                <td><span class="label label-primary">
                                                                                                        <i class="fa fa-calendar "></i>  21/09/2016  &nbsp; &nbsp;  <i class="fa fa-clock-o">

                                                                                                        </i>  09:30 AM </span></td>

                                                                                                <td><span class="label label-warning icon-animated-bell">PENDIENTE</span>
